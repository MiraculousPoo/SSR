<template>
  <div class="aside">
    ...
    <div class="history">
      <el-row type="flex" justify="space-between" class="history-delete">
        <h5>
          历史查询
        </h5>
        <el-tooltip class="item" effect="dark" content="清除历史查询" placement="top">
          <el-button type="danger" icon="el-icon-delete" circle size="mini" @click="deleteHistory" />
        </el-tooltip>
      </el-row>
